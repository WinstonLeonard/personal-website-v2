...
const IntroText = memo(() => (
  <div className="flex flex-col p-5 lg:items-start">
    ...
    <div>
      ...
      >
        I'm a Computer Science Undergraduate at NUS (National University of
        Singapore), specializing in Software Engineering, Artificial
        Intelligence, and Machine Learning. I thrive on building innovative
        full-stack applications and diving deep into AI/ML to develop solutions
        that challenge the status quo and shape the future of technology.
      </p>
    </div>
  </div>
));
