...
<div className="flex flex-row justify-start items-start">
    ...
    <div className="w-[96%] flex justify-start items-start ">
        <p className="w-full self-start text-justify font-md group-hover:font-semibold transition-all duration-300">Accomplished [X] as measured by [Y], by doing [Z].</p>
    </div>
</div>
...
const TechStackIcon = () => {
    return (
        <div>
            <img src={"https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg"} className="w-7 h-7 mr-2 object-contain group-hover:w-8 group-hover:h-8 transition-all duration-300" />
        </div>
    )
}
            ...
            <div className="flex flex-grow relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 group-hover:shadow-purple-500/20">
                ...
                <div className="flex flex-grow relative p-5 z-10 flex-col">
                    ...
                    <div className="items-start justify-start text-left group">
                        <p className="text-2xl font-semibold bg-gradient-to-r from-blue-200 via-white-200 to-purple-200 bg-clip-text text-transparent group-hover:font-bold transition-all duration-300">Software Engineer Intern</p>
                        <p className="text-lg font-semibold mt-3 text-gray-300 group-hover:font-bold transition-all duration-300">Continental Automotive</p>
...
const TechStackIconMobile = () => {
    return (
        <div>
            <img src={"https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/react/react-original.svg"} className="w-6 h-6 mr-2 object-contain" />
        </div>
    )
}
...
<div className="flex flex-row justify-start items-start">
    ...
    <div className="w-[96%] flex justify-start items-start ">
        <p className="w-full self-start text-left font-md ">Accomplished [X] as measured by [Y], by doing [Z].</p>
    </div>
</div>
...
const ExperienceDetailsMobile = ({direction}) => {
    return (
        <div className="group w-full flex-grow flex relative cursor-pointer">
            {/* Arrow pointing towards the content */}
            <div className={`absolute transform ${direction == "Right" ? "left-[-1rem] rotate-270" : "right-[-1rem] rotate-90"} top-7 -translate-y-1/2 w-0 h-0 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-b-[10px] border-b-gray-500/100 group-hover:border-b-purple-500/40 transition-all duration-300`}></div>
      ...
      <button className="cursor-pointer group relative transform transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg">
        <div>
          ...
          <div className="relative rounded-full w-15 h-15 bg-black/35 backdrop-blur-xl flex flex-col items-center justify-center border border-white/10 group-hover:border-white/20 transition-all duration-300">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRA50SrRU-Wf5Y-C_01W6YoP6IxtYYBv_Pw4w&s" className="w-12 h-12 object-contain rounded-full" />
          </div>
        </div>
      </button>
...
const TimelineEntryMobile = ({ }) => {
    return (
      <div className="flex flex-row group"       data-aos="zoom-in-left"
      data-aos-duration="600">
        <CircleAndLineMobile />
...
const Experience = () => {
  ...
  return (
    ...
    <div class="flex lg:hidden flex-col items-start pl-5 pr-5 justify-start">
